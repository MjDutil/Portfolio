...
export function Du() {
  ...
  const stop = (number: number, children: ReactNode, className = "") => (
    <article className={`du-stop ${className}`} data-reveal>
      <span className="du-stop-marker" aria-hidden="true">
        {pad(number)}
      </span>
      <span className="du-stop-label">
        {c.route.stop} {pad(number)}
      </span>
      {children}
    </article>
  );
            ...
            <div className="du-hero-grid">
              <div className="du-hero-copy">
                <h1 id="du-title" className="du-title">
                  {c.title}
                  <span className="du-title-spark" aria-hidden="true">
                    ✦
                  </span>
                </h1>
              ...
              <div className="du-hero-phones">
                ...
                <span className="du-hero-spark" aria-hidden="true">
                  ✦
                </span>
                ...
                <PhoneFrame
                  src={duScreens.chat}
                  label={c.screens.chat}
                  className="du-fan du-fan--left"
                />
                <PhoneFrame
                  src={duScreens.tracking}
                  label={c.screens.tracking}
                  className="du-fan du-fan--right"
                />
                <PhoneFrame
                  src={duScreens.home}
                  label={c.screens.home}
                  className="du-fan du-fan--center"
                  priority
                />
              </div>
            </div>
                ...
                <div className="du-stop-grid du-stop-grid--start">
                  <div className="du-copy">
                    ...
                    <dl className="du-spec" aria-label={c.start.specTitle}>
                      <span className="du-spec-title" aria-hidden="true">
                        {c.start.specTitle}
                      </span>
                  ...
                  <div className="du-board">
                    ...
                    <div className="du-board-card du-pieces">
                      ...
                      <div className="du-piece-row">
                        ...
                        <span className="du-piece-button du-piece-button--outline">
                          {c.creative.pieces.outline}
                        </span>
                      </div>
                      ...
                      <div className="du-piece-row">
                        {c.creative.pieces.badges.map((badge, index) => (
                          <span
                            key={badge}
                            className={`du-piece-badge du-piece-badge--${index + 1}`}
                          >
                            {badge}
                          </span>
                        ))}
                  ...
                  <div className="du-dev-visual">
                    ...
                    {duCode.code.trim() && (
                      <figure className="du-code">
                        <figcaption>
                          <span className="du-code-dots" aria-hidden="true">
                            <span />
                            <span />
                            <span />
                          </span>
        ...
        <section className="du-next" aria-labelledby="du-next-title">
          <div className="du-container">
            <div className="du-next-card">
              ...
              <span className="du-next-mark" aria-hidden="true">
                Geo.
              </span>
            </div>
          </div>
